...
//	}
//
//	account, err := zcs.GetAccount("", accountName, []string{})
//	fmt.Printf("%v\n", account)
//
//	if err != nil {
//		t.Fatalf("%v", err)
...
//	}
//
//	account, err1 := zcs.GetAccount("", accountName, []string{})
//	fmt.Printf("%v\n", account)
//
//	if err1 != nil {
//		t.Fatalf("%v", err)
...
//
//	err2 := zcs.AddAccountAliasRequest(account.ID, newAlias)
//	if err2 != nil {
//		t.Fatalf("%v", err)
//	}
//
//	err3 := zcs.RemoveAccountAliasRequest(account.ID, newAlias)
//	if err3 != nil {
//		t.Fatalf("%v", err)
//	}
//
